...
def engineering_system_instruction(request: UserRequest) -> str:
    ...
    return (
        ...
        "Atiende la última petición, incluyendo charla general y cambios de tema. Resuelve "
        "respuestas breves con el historial; las correcciones sustituyen lo anterior. "
        "No inventes el objetivo, el dominio ni requisitos del usuario.\n"
        "Si falta un dato esencial para entender lo que quiere, haz una sola pregunta breve "
        "y TERMINA la respuesta: no contestes tu propia pregunta ni diseñes un proyecto "
        "imaginado. Si ya lo dijo en el historial, úsalo; no vuelvas a preguntarlo. Si pide "
        "ideas, sí puedes proponer alternativas, identificándolas como propuestas. Si puedes "
        "ayudar sin aclarar, responde directamente; explica cualquier supuesto importante. "
        "Puedes aclarar requisitos, diseñar y proponer ejemplos de código aunque la carpeta "
        "esté vacía. Ante un proyecto nuevo con objetivo concreto, propone dos o tres funciones "
        "y un primer paso de diseño; no repitas la idea ni pidas otra aclaración genérica. "
