# ADR-0172: cesión inmediata ante entrada física del usuario
...
4. Cada acción exige el mismo contador. El helper firmado vuelve a comprobarlo antes del efecto y antes
   de cada fragmento de escritura; clic, tecla y scroll hacen la comprobación en su frontera final.
5. Los eventos de Jarvis usan una fuente privada dirigida al PID y no mueven el cursor HID. Un contador
   distinta solo puede cancelar, nunca autorizar.
