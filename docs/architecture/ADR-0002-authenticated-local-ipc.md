...
7. El control plane expondrá `health`, `runtime.info`, `runtime.metrics` y operaciones asíncronas de
   jobs. Ninguna operación directa de red, terminal o herramientas mutables estará disponible por
   IPC.
